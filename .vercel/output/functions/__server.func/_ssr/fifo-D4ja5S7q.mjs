...
import { t as checkFifoPosition, q as dispatchFifoMaterial, p as getFifoMaterials } from "./router--DqMp0Ks.mjs";
...
import { v as CircleCheck, w as TriangleAlert, K as CircleX, N as ScanLine, S as ShieldCheck, C as Clock } from "../_libs/lucide-react.mjs";
...
function FifoPage() {
  ...
  const [filterPartNumber, setFilterPartNumber] = reactExports.useState("All");
  ...
  const handleReject = (id, lotNumber2) => {
    ...
    setApprovals(updated);
    localStorage.setItem("npms_approvals", JSON.stringify(updated));
    toast.error(`Permintaan Lot ${lotNumber2} ditolak.`);
  };
  ...
  const uniquePartNumbers = ["All", ...Array.from(new Set(materials.map((m) => m.partNumber)))];
  const filteredMaterials = filterPartNumber === "All" ? materials : materials.filter((m) => m.partNumber === filterPartNumber);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "FIFO Check", subtitle: "Terapkan aliran material First-In-First-Out di seluruh lantai produksi.", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatusCard, { label: "FIFO Sesuai", value: counts.compliant, icon: CircleCheck, color: "success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatusCard, { label: "Peringatan", value: counts.warning, icon: TriangleAlert, color: "warning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatusCard, { label: "Pelanggaran FIFO", value: counts.violation, icon: CircleX, color: "destructive" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-1 border-0 shadow-soft", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Scan Nomor Lot" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Periksa posisi FIFO secara instan." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
          ...
          scanResult && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-lg p-3 text-xs flex items-start gap-2 border ${!scanResult.found ? "bg-destructive/10 text-destructive border-destructive/20" : scanResult.isNext ? "bg-success/10 text-success border-success/20" : "bg-warning/10 text-warning border-warning/20"}`, children: !scanResult.found ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: "Nomor lot tidak ditemukan" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opacity-80", children: "Pastikan lot ada di stok." })
            ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-medium", children: [
                ...
                " adalah berikutnya dalam antrian"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opacity-80", children: "Posisi 1 · gunakan material ini terlebih dahulu." })
            ] })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: "Peringatan FIFO: Bukan berikutnya dalam antrian" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "opacity-80", children: [
                "Posisi ",
                scanResult.position,
                " · Lot yang lebih lama ada untuk part ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2 border-0 shadow-soft", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Timeline Aliran Material" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: scanResult?.found ? `Urutan FIFO untuk ${scanResult.partNumber}` : "Urutan aliran lot produksi aktif" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative py-4", children: [
          ...
          timeline.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-6 text-xs text-muted-foreground", children: "Tidak ada lot aktif di timeline." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `grid gap-4 relative grid-cols-2 md:grid-cols-5`, children: timeline.map((s, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: `mt-1 text-[10px] ${isNext ? "bg-primary/10 text-primary border-primary/20" : isV ? "bg-destructive/10 text-destructive border-destructive/20" : ""}`, children: isNext ? "Gunakan berikutnya" : isV ? "Pelanggaran" : "Antrian" })
            ] }, i);
          }) })
        ] }) })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-soft", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex-row items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Material FIFO" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Semua lot yang dilacak dan status FIFO mereka saat ini" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterPartNumber, onValueChange: setFilterPartNumber, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-[180px] h-9 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Filter Nomor Part" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: uniquePartNumbers.map((part) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: part, className: "text-xs", children: part === "All" ? "Semua Part" : part }, part)) })
          ] }),
          isSupervisor && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => setIsApprovalsOpen(true), children: [
            "Antrian persetujuan supervisor ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/40 hover:bg-muted/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "ID Material" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Nomor Part" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Nomor Lot" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Tanggal Masuk" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Posisi" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-right", children: "Qty" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Status FIFO" })
        ] }) }),
        ...
        ] }) }) : filteredMaterials.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 7, className: "text-center py-10 text-muted-foreground text-sm", children: "Tidak ada material di stok." }) }) : filteredMaterials.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "hover:bg-muted/30", children: [
    ...
    isSupervisor && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isApprovalsOpen, onOpenChange: setIsApprovalsOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2 text-base", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Antrian Persetujuan Supervisor" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Tinjau permintaan persetujuan bypass FIFO yang tertunda dari operator." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-2 max-h-[350px] overflow-y-auto pr-1", children: [
        approvals.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 rounded-xl border border-border bg-card hover:bg-muted/30 transition-all space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Qty Diminta" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 justify-end pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", size: "sm", className: "h-8 text-xs text-destructive hover:bg-destructive/10 hover:text-destructive border-destructive/20 hover:border-destructive/30", onClick: () => handleReject(a.id, a.lotNumber), children: "Tolak Bypass" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", size: "sm", className: "h-8 text-xs bg-gradient-primary text-white", onClick: () => handleApprove(a), children: "Setujui Bypass" })
          ] })
        ] }, a.id)),
        approvals.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-muted-foreground text-center py-8 italic flex flex-col items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Semua antrian persetujuan bersih! Tidak ada permintaan bypass yang tertunda." })
        ] })
      ] })
    ] }) })
  ] });
