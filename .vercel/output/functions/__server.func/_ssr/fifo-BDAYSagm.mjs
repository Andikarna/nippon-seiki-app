...
import { u as useUser, C as Card, a as CardHeader, b as CardTitle, c as CardContent, I as Input, B as Button } from "./card-DwF1RqPI.mjs";
...
import { o as checkFifoPosition, m as dispatchFifoMaterial, l as getFifoMaterials } from "./router-Cmfz48Et.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "FIFO Check", subtitle: "Terapkan aliran material First-In-First-Out di seluruh lantai produksi.", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-soft", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        ...
        ] }) }) : materials.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 7, className: "text-center py-10 text-muted-foreground text-sm", children: "Tidak ada material di stok." }) }) : materials.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "hover:bg-muted/30", children: [
