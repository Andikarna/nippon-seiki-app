...
import { A as AppLayout, B as Badge, j as getPref } from "./app-layout-DIu8u0Fv.mjs";
...
import { D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-BXkIf75U.mjs";
import { n as addProductionRecord, h as getActiveLines } from "./router-Cmfz48Et.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2 border-0 shadow-soft", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Scan barcode atau isi kolom secara manual." })
        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-xl border-2 border-dashed border-primary/30 bg-primary/5 p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium", children: "Pemindai Barcode" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Fokus pada input dan scan, atau ketik manual." })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { autoFocus: true, value: form.barcode, onChange: (e) => handleBarcodeChange(e.target.value), placeholder: "Scan atau masukkan barcode (mis. K18H, K84A, SC1 126-7)...", className: "mt-4 h-12 text-base font-mono bg-background", disabled: submitting })
          ] }),
