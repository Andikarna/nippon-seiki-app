...
import { u as useUser, g as getUser, C as Card, a as CardHeader, b as CardTitle, f as CardDescription, c as CardContent, I as Input, B as Button, D as DEMO_USERS, l as loginUser } from "./card-CvatCQhy.mjs";
import { L as Label } from "./label-hPahR7yQ.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { I as Factory, M as Mail, J as Lock, K as EyeOff, r as Eye, N as ArrowRight, O as User, R as Briefcase, S as ShieldCheck } from "../_libs/lucide-react.mjs";
...
function LoginPage() {
  ...
  const handleQuickLogin = async (demoEmail, role) => {
    if (loading) return;
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 w-full max-w-[480px] py-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-2xl bg-slate-900/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-2xl overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "space-y-1 pb-6 border-b border-slate-800/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl font-semibold text-white", children: "Login to Account" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-slate-400", children: "Access the manufacturing monitoring and FIFO audit system." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6 space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleManualLogin, className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "email", className: "text-slate-300 text-xs font-semibold tracking-wide uppercase", children: "Email / Employee ID" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "email", placeholder: "operator@ins.co.id", type: "email", value: email, onChange: (e) => setEmail(e.target.value), disabled: loading, className: "pl-9 h-11 bg-slate-950/60 border-slate-800 text-slate-100 placeholder:text-slate-600 focus-visible:ring-primary focus-visible:border-primary focus-visible:ring-1" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-xs text-primary hover:underline", onClick: (e) => {
                  e.preventDefault();
                  toast.info("Demo mode: Use standard password '123456' or any characters.");
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative my-4 flex items-center justify-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative bg-slate-900 px-3 text-xs text-slate-500 uppercase font-semibold tracking-wider", children: "Quick Access Demo" })
          ] }),
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", disabled: loading, onClick: () => handleQuickLogin(demo.email, demo.role), className: "flex items-center justify-between p-3.5 rounded-xl border border-slate-800/80 bg-slate-950/35 hover:bg-slate-950/80 hover:border-slate-700/80 transition-all text-left group disabled:opacity-50 disabled:pointer-events-none cursor-pointer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 truncate max-w-[200px]", children: demo.email })
                ] })
              ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 text-center text-xs text-slate-600", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "© 2026 PT. Indonesia Nippon Seiki. All rights reserved." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-[11px] text-slate-600/70", children: "For operational support, contact System Administrator." })
      ] })
    ] })
  ] });
}
