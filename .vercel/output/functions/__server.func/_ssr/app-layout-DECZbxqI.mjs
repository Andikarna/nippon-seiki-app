...
import { u as useUser, g as getUser, s as setUser, I as Input, B as Button, d as cn } from "./card-CvatCQhy.mjs";
...
import { p as getAlerts } from "./router-cT5_Z0GV.mjs";
import { a1 as LayoutDashboard, I as Factory, Y as PackagePlus, a2 as ListChecks, Z as PackageMinus, c as Printer, a3 as Settings, p as Search, a4 as Sun, a5 as Moon, B as Bell, V as CircleX, v as TriangleAlert, a0 as Info, G as ChevronDown, O as User, a6 as LogOut, t as ChevronRight, f as Check, a7 as Circle } from "../_libs/lucide-react.mjs";
...
function AppLayout({ children, title, subtitle }) {
  ...
  if (!user) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-muted-foreground", children: "Verifying session..." })
    ] }) });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen bg-muted/40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden md:flex w-64 flex-col bg-sidebar text-sidebar-foreground shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-t border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-sidebar-accent/50 p-3 text-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sidebar-foreground/60 mt-0.5", children: "All systems operational" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-16 bg-background border-b flex items-center px-4 md:px-8 gap-3 sticky top-0 z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-md relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search part number, lot, operator...", className: "pl-9 bg-muted/50 border-0" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-80 mt-1.5 p-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuLabel, { className: "font-semibold text-sm flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Alerts & Notifications" }),
            ...
            isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-4 text-center text-xs text-muted-foreground", children: "Loading alerts..." }) : !alerts || alerts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-6 text-center text-xs text-muted-foreground", children: "No new notifications." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 max-h-64 overflow-y-auto", children: alerts.map((a) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 p-4 md:p-8 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl md:text-3xl font-semibold tracking-tight", children: isAllowed ? title : "Access Denied" }),
            subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: isAllowed ? subtitle : "Unauthorized Page Access" })
          ] }),
        ...
        isAllowed ? children : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center p-8 bg-card border rounded-xl shadow-soft max-w-md mx-auto text-center mt-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-2", children: [
            ...
            title,
            '" page. Please contact your supervisor or manager.'
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mt-6 bg-gradient-primary", onClick: () => navigate({ to: "/dashboard" }), children: "Back to Dashboard" })
        ] })
      ] })
    ] })
  ] });
