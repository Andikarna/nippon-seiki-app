...
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent, I as Input, B as Button } from "./card-CvatCQhy.mjs";
...
import { f as getReportsData, h as getActiveLines } from "./router-cT5_Z0GV.mjs";
...
function Reports() {
  ...
  const handlePrintLabel = () => {
    if (tableRows.length === 0) {
      toast.warning("No records to label.");
      return;
    }
    const labelHtml = `
      <!DOCTYPE html>
  ...
  const isFifo = selectedType === "fifo";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Reports & Print", subtitle: "Generate, preview, and export production documents.", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-soft", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3 pt-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Date range" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Production line" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: lineFilter, onValueChange: setLineFilter, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "SC", children: "Lines SC (SC-1, SC-2…)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "SS", children: "Lines SS (SS-1, SS-2…)" }),
                allLines.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: l, children: l }, l))
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-1 text-xs text-muted-foreground", children: isLoading ? "Loading…" : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-soft", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Output format" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2 border-0 shadow-soft flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex-row items-center justify-between border-b shrink-0 gap-4 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-0.5", children: [
            ...
            endDate,
            "  ·  ",
            lineFilter === "all" ? "All lines" : lineFilter
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "gap-2", onClick: handlePrintLabel, disabled: isLoading || tableRows.length === 0, title: "Print QR labels for matched records", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { className: "h-4 w-4" }),
            "Print Label"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "gap-2", onClick: handleDownload, disabled: isLoading || tableRows.length === 0, title: `Download as ${outputFormat.toUpperCase()}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
            "Download"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "gap-2 bg-gradient-primary", onClick: handlePrint, disabled: isLoading || tableRows.length === 0, title: "Print document", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6 bg-muted/30 flex-1 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: printRef, className: "bg-card rounded-xl border shadow-elevated mx-auto max-w-[760px] p-8 font-sans", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header flex items-start justify-between border-b pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Production Monitoring System · Confidential" })
            ] })
          ] }),
        ...
        tableRows.length > 15 && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-muted-foreground mt-2", children: [
          "Showing 15 of ",
          tableRows.length,
          " records — download to get full dataset."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer mt-8 flex justify-between items-end text-xs text-muted-foreground border-t pt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Supervisor / Authorized by" })
          ] }),
