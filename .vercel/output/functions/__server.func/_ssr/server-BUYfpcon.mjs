...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DDcKgDjC.mjs");
...
const manifest = {
  "06e8d08bc5ac38c8b0500b0076172b529c12875f4267fabc37900ea75ede46ac": {
    ...
    importer: () => import("./db.functions-s10mNAo3.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Cmfz48Et.mjs").then((n) => n.r),
    import("./start-DJIm7aJ5.mjs"),
