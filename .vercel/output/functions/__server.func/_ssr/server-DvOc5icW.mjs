...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D79Aalxp.mjs");
...
const manifest = {
  "06e8d08bc5ac38c8b0500b0076172b529c12875f4267fabc37900ea75ede46ac": {
    ...
    importer: () => import("./db.functions-C_AMiium.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-cT5_Z0GV.mjs").then((n) => n.r),
    import("./start-DH4NW82e.mjs"),
