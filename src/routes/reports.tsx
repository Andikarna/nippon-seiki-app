              ...
              <div className="space-y-1.5">
                ...
                <Select defaultValue="all">
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="SC">Lines SC (SC-1, SC-2, SC-3)</SelectItem>
            ...
            <div className="bg-card rounded-lg border shadow-elevated mx-auto max-w-[760px] p-8 font-sans">
              <div className="flex items-start justify-between border-b pb-4">
                <div className="flex items-center gap-3">
                  <div className="bg-white p-1 border rounded-lg flex items-center justify-center shrink-0">
                    <img src="/logo.png" alt="Nippon Seiki Indonesia" className="h-8 w-auto object-contain" />
                  </div>
                  <div>
