// Mock data for NPMS aligned with KONTROL STOCK SS COMP GT-1 2026.xlsx
export const productionLines = ["SC-1", "SC-2", "SC-3", "SS-1", "SS-2"];
...
export const dailyTrend = [
  { day: "Mon", subAssy: 1083, assy: 905 },
  { day: "Tue", subAssy: 1210, assy: 1100 },
  { day: "Wed", subAssy: 980, assy: 908 },
  { day: "Thu", subAssy: 1042, assy: 1012 },
  { day: "Fri", subAssy: 1195, assy: 950 },
  { day: "Sat", subAssy: 380, assy: 340 },
  { day: "Sun", subAssy: 0, assy: 0 },
];
...
export const alerts = [
  { id: 1, title: "FIFO Violation", desc: "Lot SC1 126-7 used out of order", severity: "error" as const },
  { id: 2, title: "Low Stock Alert", desc: "Bucket A5 (1PA) contains only 19 units", severity: "warning" as const },
  { id: 3, title: "Low Stock Alert", desc: "Bucket A4 (XD 831) contains only 41 units", severity: "warning" as const },
];
